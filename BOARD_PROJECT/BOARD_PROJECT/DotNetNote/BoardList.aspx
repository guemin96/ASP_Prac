<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="BoardList.aspx.cs" Inherits="BOARD_PROJECT.DotNetNote.BoardList" %>
<%@ Register 
    ...
    <table style="width:700px; margin-left:auto; margin-right:auto;">
        <tr>
            <td>
                ...
                <asp:GridView ID="ctlBoardList" runat="server" AutoGenerateColumns="false" DataKeyNames="Id" CssClass="table table-bordered table-hover table-condensed table-striped table-responsive" OnSelectedIndexChanged="ctlBoardList_SelectedIndexChanged">
                    <Columns>
