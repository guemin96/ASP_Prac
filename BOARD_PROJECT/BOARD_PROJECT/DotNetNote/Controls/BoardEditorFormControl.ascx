<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BoardEditorFormControl.ascx.cs" Inherits="BOARD_PROJECT.DotNetNote.Controls.BoardEditorFormControl" %>
<style>
...
<table style="width:600px; border-collapse: collapse; 
    ...
    <% if (!String.IsNullOrEmpty(Request.QueryString["Id"]) && 
            FormType == BOARD_PROJECT.DotNetNote.Models.BoardWriteFormType.Modify) { %>    
    <tr>
