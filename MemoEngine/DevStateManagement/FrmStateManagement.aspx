...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <h3>클라이언트에 저장</h3>
            Cookie 개체 : <asp:TextBox ID="txtCookies" runat="server"></asp:TextBox><br />
            ViewState 개체 : <asp:TextBox ID="txtViewState" runat="server"></asp:TextBox><br />
            <hr />

            <asp:LinkButton ID="btnSave" runat ="server" OnClick="btnSave_Click">상태 변수에 데이터 저장</asp:LinkButton>&nbsp;
